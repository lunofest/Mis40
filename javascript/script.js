...
function updateTimer() {
  const targetDate = new Date("February 1, 2025 20:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541164653277'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '541164653277'; // Número para el primer botón
